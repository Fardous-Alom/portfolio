...
import img1 from "/src/assets/images/experience/1.png";
import img2 from "/src/assets/images/experience/2.jpeg";
      ...
      <div>
        <div className="group relative flex gap-x-5">
          <div className="relative group-last:after:hidden after:absolute after:top-8 after:bottom-2 after:start-3 after:w-px after:-translate-x-[0.5px] after:bg-gray-200 dark:after:bg-neutral-700">
            <div className="relative z-10 size-6 flex justify-center items-center">
              <img src={img2} alt="" className="size-6 object-cover" />
            </div>
          </div>
          ...
          <div className="grow pb-8 group-last:pb-0">
            ...
            <ul className="list-disc ms-6 mt-3 space-y-1.5">
              <li className="ps-1 text-sm text-gray-600 dark:text-neutral-400">
                ...
                imports, image optimization, and caching strategies boosted
                overall performance by 40% and improved load time on slow
                networks.
              </li>
              <li className="ps-1 text-sm text-gray-600 dark:text-neutral-400">
                Solved excessive re-renders and repeated API calls by
                integrating Redux and memoized selectors cut down redundant
                network requests by 30% and improved app responsiveness.
              </li>
              <li className="ps-1 text-sm text-gray-600 dark:text-neutral-400">
                Audited and enhanced accessibility by fixing ARIA roles,
                contrast issues, and keyboard traps achieved WCAG 2.1 compliance
                and lifted SEO score by 25% on Lighthouse.
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="group relative flex gap-x-5">
          ...
          <div className="grow pb-8 group-last:pb-0">
            ...
            <p className="font-semibold text-sm text-gray-800 dark:text-neutral-200">
              Frontend Developer(Intern) | Barrack
            </p>
            <ul className="list-disc ms-6 mt-3 space-y-1.5">
              <li className="ps-1 text-sm text-gray-600 dark:text-neutral-400">
                Designed intuitive, user-centric interfaces that enhanced
                usability and engagement.
              </li>
              <li className="ps-1 text-sm text-gray-600 dark:text-neutral-400">
                Created high-fidelity wireframes and interactive prototypes to
                bring concepts to life.
              </li>
              <li className="ps-1 text-sm text-gray-600 dark:text-neutral-400">
                Optimized design workflows, improving efficiency and
