    ...
    <div className="min-h-screen w-full max-w-6xl mx-auto overflow-hidden px-4 md:px-6 lg:px-10 py-5">
      ...
      <div className="grid gap-6">
        {projects.map((project) => (
          <div key={project.id} className="bg-white dark:bg-gray-800 rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition-shadow p-6 flex flex-col md:flex-row gap-4 items-center">
            <img
              src={new URL(`../assets/images/projects/${project.image}`, import.meta.url).href}
              alt={project.title}
